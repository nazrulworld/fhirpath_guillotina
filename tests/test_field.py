...
def test_field_validate(dummy_guillotina):
    ...
    organization = implementer(IFhirResource)(lookup_fhir_class("Organization"))(
        json_dict
    )
...
def test_fhir_field_value(dummy_guillotina):
    ...
    model = implementer(IFhirResource)(lookup_fhir_class(fhir_json["resourceType"]))
...
async def test_fhir_field_schema_serializer(dummy_request):
    ...
    serializer = get_multi_adapter(
        (fhir_field, IOrganization, dummy_request), ISchemaFieldSerializeToJson
    )
